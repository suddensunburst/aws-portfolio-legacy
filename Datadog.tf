...
resource "datadog_integration_aws_account" "datadog_integration" {
  ...
  logs_config {
    lambda_forwarder {
      ...
      sources = ["apigw-access-logs", "apigw-execution-logs", "appsync", "batch", "bedrock-agentcore", "cloudfront", "cloudtrail", "codebuild", "dms", "docdb", "ecs", "eks", "eks-container-insights", "elb", "elbv2", "glue", "iot", "lambda", "lambda-edge", "mwaa", "network-firewall", "pcs", "rds", "redshift", "redshift-serverless", "route53", "route53-resolver", "s3", "ssm", "states", "verified-access", "vpc", "vpn", "waf"]
      log_source_config {
      }
    }
  }
